...
| `scopes/Widgets/dialog.scope.md` | HTML primitive (`dialog`); `spec/README.md` rule | "Modal or non-modal dialog with title, content, and actions." | Purpose; Child model (title, content, actions from the HTML `dialog` element). |
