...
9.1. **Run full validation**
    - Add the generator validation tests to the output fixture workspace.
    - Add the generator validation command to the repo validation recipe.
    - Add the generator validation command to the CI build.yml.
    - Run repository validation as described in [spec/README.md § Validation](../../../../../spec/README.md#validation)
