...
npm install
npm run build
node dist/src/main.js generate --input input.json --out /tmp/openui-angular-app
```
...
node dist/src/main.js generate --input input.json --out ./my-app

# Generate into an existing workspace (incremental)
node dist/src/main.js generate --input updated-input.json --out ./my-app
```
