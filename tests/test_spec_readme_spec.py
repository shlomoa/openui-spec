...
EXPECTED_SPEC_MARKDOWN = [
    ...
    "scopes/Controls/picker_control.scope.md",
    "scopes/Controls/range_control.scope.md",
    "scopes/Controls/scope.md",
    "scopes/Controls/status_indicator.scope.md",
    ...
    "scopes/Views/form.scope.md",
    "scopes/Views/report.scope.md",
    "scopes/Views/scope.md",
    "scopes/Widgets/chart.scope.md",
