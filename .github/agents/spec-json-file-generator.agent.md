...
- Use `spec/README.md`, the section documents in `spec/` or `spec.old/`, `docs/REQUIREMENTS.md`, `docs/GENERATOR_STRUCTURE.md`, `docs/REPO_CODE_GENERATION.md`, `origin/TRAVERSAL_REPORT.md`, and relevant tests as source material.
